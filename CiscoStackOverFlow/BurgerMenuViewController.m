...
@property (strong,nonatomic) ContentViewController *topViewController;
...
-(void)setupContentViewController{
    ContentViewController *contentViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"ContentVC"];
...
-(void)setupBurgerButton{
    ...
    [burgerButton setImage:[UIImage imageNamed:@"menuButton"] forState:UIControlStateNormal];
...
-(void)switchToViewController:(ContentViewController *)viewController{
    [UIView animateWithDuration:ktimeToSlideMenuOpen animations:^{
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ContentViewController *viewController = self.viewControllers[indexPath.row];
